...
const ConferencePage = () => {
    ...
    // Function to check if conference is upcoming
    const isUpcoming = (conference) => {
        return conference.eventStatus === "upcoming" || new Date(conference.date.split(" - ")[0]) > new Date()
    }
                            ...
                            <div className="mb-8">
                                <div className="flex flex-wrap gap-2">
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-full text-sm transition-colors ${selectedTag === "all" ? "bg-[#0e8601] text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                                            }`}
                                    >
                                        All
                                    </button>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="relative h-48 bg-gray-200">
                                                {upcoming && conference.conferenceImage ? (
                                                    // Show conference poster for upcoming events
                                                    <div className="relative w-full h-full">
                                                        <Image
                                                            src={conference.conferenceImage || "/placeholder.svg"}
                                                    ...
                                                    <div className="w-full h-full bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center">
                                                        <div className="text-center text-white">
                                                            ...
                                                            {firstVideo && <p className="text-xs mt-1 opacity-90">{firstVideo.title}</p>}
                                                        </div>
                                                    </div>
                                                ) : embedUrl ? (
                                            ...
                                            <div className="p-6">
                                                ...
                                                <div className="flex items-center mb-4">
                                                    ...
                                                    <div>
                                                        <p
                                                            className={`text-sm ${conference.featured && index === 0 && currentPage === 1 && selectedTag === "all"
                                                                ? "text-gray-200"
                                                                : "text-gray-500"
                                                                }`}
                                                        >
                                                        ...
                                                        <p
                                                            className={`font-semibold ${conference.featured && index === 0 && currentPage === 1 && selectedTag === "all"
                                                                ? "text-white"
                                                                : "text-gray-900"
                                                                }`}
                                                        >
                                                ...
                                                {/* Theme for upcoming conferences */}
                                                {upcoming && conference.theme && (
                                                    <div className="mb-3 p-2 bg-green-50 rounded-lg border-l-4 border-green-500">
                                                        <p className="text-xs font-medium text-green-700 mb-1">Conference Theme:</p>
                                                        <p className="text-sm text-green-600">{conference.theme}</p>
                                                    </div>
                                                )}

                                                {/* Description */}
                                                <p
                                                    className={`text-sm mb-4 ${conference.featured && index === 0 && currentPage === 1 && selectedTag === "all"
                                                        ? "text-gray-200"
                                                        : "text-gray-600"
                                                        }`}
                                                >
                                                ...
                                                <div className="space-y-2 mb-4">
                                                    <div className="flex items-center">
                                                        <Calendar
                                                            className={`w-4 h-4 mr-2 ${conference.featured && index === 0 && currentPage === 1 && selectedTag === "all"
                                                                ? "text-gray-200"
                                                                : "text-gray-500"
                                                                }`}
                                                        />
                                                ...
                                                {conference.partners && (
                                                    <div className="mb-4">
                                                        <p
                                                            className={`text-xs mb-2 ${conference.featured && index === 0 && currentPage === 1 && selectedTag === "all"
                                                                ? "text-gray-300"
                                                                : "text-gray-500"
                                                                }`}
                                                        >
                                                ...
                                                <div className="flex justify-between items-center">
                                                    <div className="flex gap-2">
                                                        ...
                                                        {upcoming && conference.websiteUrl && (
                                                            <a
                                                                href={conference.websiteUrl}
                                                                target="_blank"
                                                                rel="noopener noreferrer"
                            ...
                            <div className="flex justify-center items-center space-x-2">
                                ...
                                {[...Array(totalPages)].map((_, i) => (
                                    <button
                                        ...
                                        className={`w-10 h-10 rounded-full font-medium transition-colors ${currentPage === i + 1 ? "bg-[#0e8601] text-white" : "bg-white text-gray-700 hover:bg-gray-100"
